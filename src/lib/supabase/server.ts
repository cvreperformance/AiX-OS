...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL?.includes('fcpsafjgjnecdlyqfcid')
  ? process.env.NEXT_PUBLIC_SUPABASE_URL
  : "https://fcpsafjgjnecdlyqfcid.supabase.co";
const SUPABASE_ANON_KEY = (process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.startsWith('eyJ') && process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.includes('fcpsafjgjnecdlyqfcid'))
