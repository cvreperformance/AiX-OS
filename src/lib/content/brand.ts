  ...
  services: [
    {
      ...
      href: "/buyer",
      desc: "Find properties directly from owners before they reach public portals, and save up to 3% in agent commissions.",
      descRO: "Găsește proprietăți direct de la proprietar înainte să apară pe portalurile publice și economisește până la 3% din valoarea tranzacției.",
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        "Leverage 600+ partner agents to find a buyer in under 30 days",
    ...
    },
    {
      ...
      href: "/insurance",
      desc: "Compare coverage options from 15+ accredited insurers to lower your premium rates by up to 20% while securing full asset protection.",
      descRO: "Compară ofertele de la 15+ asigurători autorizați pentru a reduce costurile cu asigurările cu până la 20%.",
      features: [
        ...
        "Compare quotes and issue policies online in under 5 minutes",
      ],
    },
    {
      ...
      features: [
        ...
        "Project price trends for the next 12 to 24 months based on BNR data",
