...
import { saveCapture, deleteCapture, getRecentCaptures } from '@/app/actions/personal.actions';
...
export default function CaptureClient({ initialCaptures }: CaptureClientProps) {
