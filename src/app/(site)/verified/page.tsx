  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 space-y-16 animate-in text-left">
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="p-8 md:p-12 rounded-[40px] bg-zinc-50/40 border border-amber-500/20 text-center relative overflow-hidden">
          ...
          <h2 className="text-3xl font-light text-zinc-900 mb-4">What does AiX Verified™ mean?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="p-6 rounded-3xl bg-white/50 border border-zinc-200 text-center space-y-4">
