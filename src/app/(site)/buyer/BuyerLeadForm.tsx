...
export default function BuyerLeadForm() {
  ...
  if (success) {
    return (
      <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6 text-center space-y-2 animate-in fade-in duration-300">
        ...
        <p className="text-xs text-zinc-400">Consilierul desemnat vă va contacta în maxim 24 de ore.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      {/* Honeypot Spam Protection (Hidden from human eyes) */}
      <input
        type="text"
        name="botfield"
        value={botfield}
      ...
      >
        ...
        <option value="Comercial / Birou">Comercial / Birou</option>
        <option value="Teren">Teren</option>
        <option value="Orice oportunitate bună">Orice oportunitate bună</option>
      </select>
