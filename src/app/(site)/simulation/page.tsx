...
export default function WealthSimulationPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-12 space-y-12 animate-in text-left">
      ...
      {step === "inputs" && (
        <div className={`p-6 sm:p-8 rounded-3xl ${designSystem.glass} space-y-6 relative overflow-hidden`}>
          ...
          <div className="flex items-center gap-2 border-b border-zinc-200 pb-3">
            ...
            <h3 className="text-xs font-semibold text-zinc-900 uppercase tracking-wider font-mono">Consultation Parameters</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-zinc-400">
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase font-mono font-bold text-zinc-400">Capital Size (€)</label>
              <select
                value={capital}
                onChange={(e) => setCapital(e.target.value)}
                className="w-full rounded-xl border border-zinc-200 bg-zinc-50/40 px-3.5 py-2.5 text-xs text-zinc-900 focus:border-amber-500/40 focus:outline-none"
              >
            ...
            {/* Core Objective */}
            <div className="space-y-2">
              <label className="text-[10px] uppercase font-mono font-bold text-zinc-400">Core Objective</label>
              <select
                value={objective}
            ...
            {/* Timeline */}
            <div className="space-y-2">
              <label className="text-[10px] uppercase font-mono font-bold text-zinc-400">Timeline (Years)</label>
              <select
                value={timeline}
            ...
            {/* Preference */}
            <div className="space-y-2">
              <label className="text-[10px] uppercase font-mono font-bold text-zinc-400">Asset Class Preference</label>
              <select
                value={preference}
      ...
      {/* ─── LOADING STATE ───────────────────────────────────────────────── */}
      {step === "calculating" && (
        <div className={`p-12 rounded-3xl border border-zinc-200 bg-white/20 backdrop-blur-xl text-center space-y-6`}>
          <RefreshCw className="h-10 w-10 text-amber-500 animate-spin mx-auto" />
          <div className="space-y-1">
            <h3 className="text-sm font-semibold text-zinc-900">Running Strategic Algorithms</h3>
            <p className="text-xs text-zinc-400 font-mono">ESTIMATING DYNAMIC ALLOCATIONS</p>
          </div>
        </div>
      )}
        ...
        <div className="space-y-6">
          ...
          <div className={`p-6 sm:p-8 rounded-3xl border border-zinc-200 bg-white/85 backdrop-blur-xl relative overflow-hidden space-y-6`}>
            ...
            <div className="flex justify-between items-center border-b border-zinc-200 pb-4">
              <div>
                <h3 className="text-sm font-semibold text-zinc-900">Simulation Output Report</h3>
            ...
            <div className="space-y-4">
              <h4 className="text-[9px] font-mono uppercase tracking-widest text-zinc-400 font-bold">Suggested Allocation Spread</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-xs font-mono">
                {[
                  ...
                  { label: "Sovereign Cash Reserves", val: "10%", color: "border-zinc-200 bg-white text-zinc-400" }
                ].map((alloc, i) => (
            ...
            <div className="space-y-4 border-t border-zinc-200 pt-5">
              <h4 className="text-[9px] font-mono uppercase tracking-widest text-zinc-400 font-bold">Real Estate Roadmap Timeline</h4>
              
              <div className="relative border-l border-zinc-200 ml-3 pl-6 space-y-6 text-xs text-zinc-400 text-left">
                <div className="relative">
                  <div className="absolute -left-[30px] top-0.5 h-3 w-3 rounded-full bg-amber-500" />
                  <p className="font-semibold text-zinc-900">Phase 1: Direct Core Acquisitions</p>
            ...
            <div className="space-y-4 border-t border-zinc-200 pt-5">
              <h4 className="text-[9px] font-mono uppercase tracking-widest text-zinc-400 font-bold">Asset Protection Strategy</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                {[
                  ...
                  <div key={idx} className="flex gap-2.5 items-start p-3 rounded-xl bg-white/40 border border-zinc-200">
