                      ...
                      <form onSubmit={handleRequestAudit} className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <input
                              ...
                              className={`w-full rounded-lg border ${fieldErrors.leadName ? 'border-red-500' : 'border-zinc-200'} bg-zinc-50/40 px-3 py-2 text-[11px] text-zinc-900 placeholder-zinc-650 focus:border-red-500/50 focus:outline-none transition-colors`}
                            />
                          ...
                          <div>
                            <input
                              ...
                              placeholder="Telefon"
                              className={`w-full rounded-lg border ${fieldErrors.leadPhone ? 'border-red-500' : 'border-zinc-200'} bg-zinc-50/40 px-3 py-2 text-[11px] text-zinc-900 placeholder-zinc-650 focus:border-red-500/50 focus:outline-none transition-colors`}
                            />
                        ...
                        <div>
                          <input
                            ...
                            placeholder="E-mail"
                            className={`w-full rounded-lg border ${fieldErrors.leadEmail ? 'border-red-500' : 'border-zinc-200'} bg-zinc-50/40 px-3 py-2 text-[11px] text-zinc-900 placeholder-zinc-650 focus:border-red-500/50 focus:outline-none transition-colors`}
                          />
