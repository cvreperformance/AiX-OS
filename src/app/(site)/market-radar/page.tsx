...
export default function MarketRadarPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12 space-y-12 animate-in text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {filteredLocations.map((loc) => (
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start gap-2">
                <div className="space-y-1">
                  ...
                  <h3 className="text-sm font-semibold text-zinc-900 truncate max-w-[150px]">{loc.city}</h3>
              ...
              {/* Metrics */}
              <div className="grid grid-cols-2 gap-4 border-t border-zinc-200/60 pt-4 text-xs font-mono">
                <div>
            ...
            <div className="pt-4 border-t border-zinc-200/60 flex justify-between items-center text-[10px] font-mono">
      ...
      <div className={`p-6 sm:p-8 rounded-3xl border border-zinc-200 bg-white/20 text-xs text-zinc-450 space-y-4`}>
        <div className="flex items-center gap-2">
          <Sparkles className="h-4.5 w-4.5 text-amber-500 animate-pulse" />
          <h4 className="text-xs font-semibold text-zinc-900 uppercase tracking-wider font-mono">Radar Intelligence Directive</h4>
        </div>
