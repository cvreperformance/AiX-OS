...
export function SkeletonCard() {
  return (
    <div className="animate-pulse rounded-2xl border border-zinc-200 bg-zinc-50/30 overflow-hidden">
...
export function SkeletonPageHeader() {
  return (
    <div className="mb-12 space-y-4 animate-pulse">
      ...
      <div className="h-12 w-80 rounded bg-zinc-100" />
      <div className="h-5 w-96 rounded bg-zinc-100" />
    </div>
  );
}
...
export function SkeletonAgencyCard() {
  return (
    <div className="animate-pulse rounded-2xl border border-zinc-200 bg-zinc-50/30 p-6 space-y-4">
...
export function SkeletonIndicatorRow({ count = 4 }: { count?: number }) {
  return (
    <div className="flex gap-4 overflow-hidden">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="animate-pulse flex-shrink-0 rounded-xl border border-zinc-200 bg-zinc-50/30 p-4 space-y-2 min-w-[140px]">
          <div className="h-3 w-20 rounded bg-zinc-100" />
          <div className="h-6 w-16 rounded bg-zinc-100" />
