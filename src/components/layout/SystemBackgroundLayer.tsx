...
export function SystemBackgroundLayer() {
  return (
    <div className="fixed inset-0 z-[-1] pointer-events-none overflow-hidden select-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-30 animate-pulse duration-[12000ms] scale-75 sm:scale-100">
                <Brain className="w-[20rem] h-[20rem] md:w-[60rem] md:h-[60rem] text-amber-400 stroke-[0.2]" fill="none" />
      </div>
    </div>
  );
}
