          ...
          return (
            <div key={category.id} className="space-y-3">
              <div className="flex items-center gap-2.5 border-b border-zinc-900/80 pb-2">
                ...
                <h3 className="text-[10px] font-bold text-zinc-300 uppercase tracking-wider leading-none">
                  ...
                  return (
                    ...
                    >
                      <div className="mt-0.5 opacity-35 group-hover:opacity-100 transition-opacity flex-shrink-0">
                        <ItemIcon className="h-3 w-3 text-zinc-500 group-hover:text-amber-400 transition-colors" />
                      </div>
                      <div>
                        ...
                        <p className="text-[10px] text-zinc-650 leading-tight mt-0.5 line-clamp-1 group-hover:text-zinc-500 transition-colors">
